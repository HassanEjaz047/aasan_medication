...
class ParamedicSafetyScreen extends StatefulWidget {
  const ParamedicSafetyScreen({Key? key}) : super(key: key);

  @override
  State<ParamedicSafetyScreen> createState() => _ParamedicSafetyScreenState();
}


class _ParamedicSafetyScreenState extends State<ParamedicSafetyScreen> {
