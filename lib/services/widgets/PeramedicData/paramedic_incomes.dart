...
class ParamedicsIncomes extends StatefulWidget {
  ParamedicsIncomes({Key? key,required this.getHistory}) : super(key: key);
  ParamedicServiceList getHistory;
  @override
  State<ParamedicsIncomes> createState() => _ParamedicsIncomes();
}

class _ParamedicsIncomes extends State<ParamedicsIncomes> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text("completed", style: AppTextStyles.popins(
                  style: const TextStyle(
                      fontSize: 14,
